        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="flex items-start gap-3">
                  <input
                    ...
                    className="h-4 w-4 text-primary-500 focus:ring-indigo-500 border-border rounded mt-0.5"
                  />
              ...
              <Button
                type="submit"
                className="w-full bg-indigo-500 cursor-pointer"
                loading={loading}
              >
                Create Account
              </Button>
        ...
        <div className="space-y-4">
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t p-6 border-border"></div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="flex items-center gap-2 cursor-pointer focus:outline-transparent focus:ring-transparent"
            >
