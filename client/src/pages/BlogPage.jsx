  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">
          Blog Posts
        </h1>
        <p className="text-lg text-text-secondary max-w-2xl mx-auto">
          Discover insights, stories, and knowledge from our community of writers and creators
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-semibold text-text-primary">Categories:</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between py-4 border-b border-border">
        <div className="text-text-secondary">
          Showing <span className="font-semibold text-text-primary">{filteredBlogs.length}</span> of{' '}
          <span className="font-semibold text-text-primary">{sampleBlogs.length}</span> posts
        </div>
