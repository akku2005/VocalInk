      ...
      <div className="text-center py-8 lg:py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl lg:text-6xl font-bold text-text-primary mb-6 leading-tight">
            Welcome to <span className="text-primary-500 bg-gradient-to-r from-primary-500 to-primary-600 bg-clip-text text-transparent">VocalInk</span>
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <Card className="hover:shadow-lg transition-all duration-300 group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium group-hover:text-primary-500 transition-colors">Total Blogs</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-text-secondary mt-1">+12% from last month</p>
          </CardContent>
        </Card>

        <Card className="hover:shadow-lg transition-all duration-300 group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium group-hover:text-primary-500 transition-colors">Active Users</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-text-secondary mt-1">+8% from last month</p>
          </CardContent>
        </Card>

        <Card className="hover:shadow-lg transition-all duration-300 group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium group-hover:text-primary-500 transition-colors">Series Created</CardTitle>
        ...
        <Card className="hover:shadow-lg transition-all duration-300 group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium group-hover:text-primary-500 transition-colors">AI Generations</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-text-secondary mt-1">+25% from last month</p>
          </CardContent>
        </Card>
      </div>
