    ...
    setTimeout(() => {
      setBadges([
        // Writing Badges
        {
          ...
          earnedAt: '2023-01-15',
          requirements: [
            { text: 'Publish 1 blog post', completed: true }
          ]
        },
        {
          id: 2,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Publish 50 blog posts', completed: false, current: 23, target: 50 }
          ]
        },
        {
          id: 3,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Publish 100 blog posts', completed: false, current: 23, target: 100 }
          ]
        },
        {
          id: 4,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Publish 500 blog posts', completed: false, current: 23, target: 500 }
          ]
        },
        ...
        },
        {
          ...
          earnedAt: null,
          requirements: [
            { text: 'Get 10,000+ views on a single post', completed: false, current: 6500, target: 10000 }
          ]
        },
        {
          id: 7,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Left 100+ meaningful comments', completed: false, current: 45, target: 100 }
          ]
        },
        ...
        },
        {
          ...
          earnedAt: null,
          requirements: [
            { text: 'Create 10+ blog series', completed: false, current: 2, target: 10 }
          ]
        },
        ...
        },
        {
          ...
          earnedAt: null,
          requirements: [
            { text: 'Used AI features 10+ times', completed: false, current: 7, target: 10 }
          ]
        },
        ...
        // Social Badges
        {
          ...
          earnedAt: '2023-05-12',
          requirements: [
            { text: 'Followed 50+ users', completed: true }
          ]
        },
        {
          id: 13,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Have 1,000+ followers', completed: false, current: 800, target: 1000 }
          ]
        },
        ...
        // Consistency Badges
        {
          ...
          earnedAt: null,
          requirements: [
            { text: 'Post for 30 consecutive days', completed: false, current: 15, target: 30 }
          ]
        },
        {
          id: 15,
          ...
          earnedAt: null,
          requirements: [
            { text: 'Post for 7 consecutive days', completed: false, current: 5, target: 7 }
          ]
        },
        ...
        },
        {
          ...
          earnedAt: null,
          requirements: [
            { text: 'Tested beta features and provided feedback', completed: false }
          ]
        }
      ]);
      setLoading(false);
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-text-secondary">Unlock achievements and showcase your progress</p>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="text-text-secondary">
          Showing <span className="font-semibold text-text-primary">{filteredBadges.length}</span> of{' '}
          <span className="font-semibold text-text-primary">{totalBadges}</span> badges
        </div>
        <div className="text-sm text-text-secondary">
          {earnedBadges.length} earned • {totalBadges - earnedBadges.length} remaining
        </div>
      </div>
          ...
          <Card key={badge.id} className="hover:shadow-lg transition-all duration-300 cursor-pointer border border-[var(--border-color)]" onClick={() => setBadgeModal({ open: true, badge })}>
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                {/* Badge Info */}
                <div>
                  <h3 className="font-semibold text-text-primary text-lg mb-2">{badge.name}</h3>
                  ...
                  <div className="flex justify-center mb-3">
                    <Badge className={rarities.find(r => r.id === badge.rarity)?.color}>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-text-primary">{badge.progress}%</span>
                    </div>
                  ...
                  <div className="mt-4 space-y-2">
                    {badge.requirements.map((req, index) => (
                      <div key={index} className="flex items-center gap-2 text-sm">
                        ...
                        <span className={req.completed ? 'text-success' : 'text-text-secondary'}>
                          {req.text}
