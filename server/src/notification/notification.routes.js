...
router.patch('/:notificationId/unread', protect, notificationController.markNotificationUnread);
...
// Admin routes
router.post('/system', protect, requireAdmin, notificationController.createSystemNotification);
